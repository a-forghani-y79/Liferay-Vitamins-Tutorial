 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.denbinger.vitamins.service.PersistedVitaminService</code> interface.
 *
 * <p>
...
public class PersistedVitaminServiceImpl
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never reference this class directly. Always use <code>com.denbinger.vitamins.service.PersistedVitaminServiceUtil</code> to access the persisted vitamin remote service.
     */
