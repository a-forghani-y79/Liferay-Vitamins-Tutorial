...
public class VitaminDetailLocalServiceImpl
	 ...
	 */
	public VitaminDetail addVitaminDetail(final long persistedVitaminId,
										  final int typeCode,
										  final String value,
										  final ServiceContext serviceContext)
			throws PortalException {

		VitaminDetail detail = createVitaminDetail(counterLocalService.
				increment(VitaminDetail.class
						.getName()));
		...
		resourceLocalService.addResources(
				...
				VitaminDetail.class.getName(),
				detail.getVitaminDetailId(),
				false,
	...
	private static final Logger _log =
			LoggerFactory.getLogger(VitaminDetailLocalServiceImpl.class);
