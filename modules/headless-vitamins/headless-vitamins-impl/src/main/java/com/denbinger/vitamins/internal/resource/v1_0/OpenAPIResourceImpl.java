...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "HeadlessVitamins REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "HeadlessVitamins", version = "v1.0")
)
@Path("/v1.0")
