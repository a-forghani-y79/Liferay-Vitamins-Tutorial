package com.denbinger.vitamins.resource.v1_0.test;

import com.denbinger.vitamins.client.dto.v1_0.Vitamin;
import com.denbinger.vitamins.client.http.HttpInvoker;
import com.denbinger.vitamins.client.pagination.Page;
import com.denbinger.vitamins.client.pagination.Pagination;
import com.denbinger.vitamins.client.resource.v1_0.VitaminResource;
import com.denbinger.vitamins.client.serdes.v1_0.VitaminSerDes;
...
public abstract class BaseVitaminResourceTestCase {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (Field field :
				ReflectionUtil.getDeclaredFields(
					com.denbinger.vitamins.dto.v1_0.Vitamin.class)) {
	...
	@Inject
	private com.denbinger.vitamins.resource.v1_0.VitaminResource
		_vitaminResource;
